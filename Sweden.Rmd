...
df %>% filter(date >="2020-01-01" ) %>%
  ...
  labs(title="Deaths: Plot of Tuesday - Friday Data. ")
...
plot1 <- ggplot(df) + geom_col(aes(x=date,y=CMA,col=CMA)) + 
...
plot2 <- ggplot(df) + geom_col(aes(x=date,y=DMA,col=DMA)) + 
