...
ggplot() + geom_line(aes(x=Reported,y=Rate)) +
  ...
  labs(title="COVID19 Mortality Rate ",x="Date Reported",y="Mortality Rate") + geom_hline(yintercept = mean(na.omit(df$Rate)),col="red",lwd=1.5)
